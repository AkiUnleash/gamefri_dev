...
import { profile, diarywrite, follow, nice } from '../utils/common-types'
...
// Firestoreにデータを保存
export const dataAdd = <T extends profile | diarywrite | follow | nice, U extends place, V extends boolean>
